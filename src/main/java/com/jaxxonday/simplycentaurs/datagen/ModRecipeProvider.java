...
//                .pattern("###")
//                .pattern("###")
//                .define('#', ModItems.SAPPHIRE_PIECE.get())
//                .unlockedBy(getHasName(ModItems.SAPPHIRE_PIECE.get()), has(ModItems.SAPPHIRE_PIECE.get()))
//                .save(pWriter);

//        ShapelessRecipeBuilder.shapeless(RecipeCategory.MISC, ModItems.SAPPHIRE.get(), 9)
//                .requires(ModItems.SAPPHIRE_PIECE.get())
//                .unlockedBy(getHasName(ModItems.SAPPHIRE_PIECE.get()), has(ModItems.SAPPHIRE_PIECE.get()))
//                .save(pWriter);
